    ...
    return (
        <div className='ContractUs d-flex justify-content-around'>
           <div className='ContractUs-Text'>
               ...
               <br />
               <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique cumque corporis ad voluptas, inventore aspernatur odit id harum suscipit libero magni rerum quibusdam corrupti illo amet quasi, quis praesentium esse!</p>
            </div> 
