    ...
    return (
        <div className='ContractUs d-flex justify-content-around'>
           <div className='ContractUs-Text'>
               ...
               <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique cumque corporis ad voluptas,<br/> inventore aspernatur odit id harum suscipit libero magni rerum quibusdam corrupti illo amet!</span>
            </div> 
