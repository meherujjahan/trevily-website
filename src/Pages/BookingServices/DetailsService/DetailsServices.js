...
const DetailsServices = () => {
    ...
    //const {id, img, price,place}= useService();
        ...
        useEffect(()=>{
          fetch(`https://stormy-chamber-95883.herokuapp.com/services/${_id}`)
          .then(res=> res.json())
          .then(data=>{
            setBooking(data)
          })
        ...
        fetch('https://stormy-chamber-95883.herokuapp.com/serve',{
          method: "POST",
          headers : {
    ...
    return (
        <div>
            <Button>Details Service</Button>
             <div className='ContractUs3 d-flex justify-content-around'>
          
           <div className='ContractUs3-Text'>
           <Col>
        <Card className='service-card'>
        <Card.Img className="Img" variant="top" src={booking.img} />
          ...
          <b>Total Cost: {booking.price}$</b> 
            ...
            <div className='details'>
             <form onSubmit={handleSubmit}>
                            ...
                            <textarea style={{width:"100%"}} ref={desRef} type="text" required id="lname5" name="lastname" placeholder="Your address" /><br />
                            <input style={{width:"100%"}} ref={numRef} type="number" required id="lname" placeholder="Phone Number" /><br />
                            ...
                            <input style={{backgroundColor:"rgba(252, 80, 17, 0.877)"}} type="submit" value="Place Order" />
                        </form>
            </div>
        </div>
        </div>
